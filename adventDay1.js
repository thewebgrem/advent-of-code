...
// The first example with the result already confirmed
...
// The second example with this new data from which we had to calculate the correct answer
console.log(calculateTimesDepthIncreased(testData));
